...
def mocked_read_csv(*args):
    ...
    data_scripts_raw = [
        ['JERRY', 'Do you know what this is all about? \
            ...
            Where ever you are in life, its my feeling, \
            youve gotta go.', 'S01E01',
         1, 1, 0.24, 0, 0, 0.41, 0.35, 189],
        ['JERRY', '(pointing at Georges shirt) See, to me, that button is in \
            the worst possible spot. \
            The second button literally makes or \
                breaks the shirt, look at it.\
        ...
        ['MAN', 'Yes, it was purple, I liked it, \
            I dont actually recall considering \
            the buttons.', 'S01E02', 1, 2, 0, 0.5, 0, 0.5, 0, 14],
        ['WOMAN', 'Yes, it was purple, I liked it, \
            I dont actually recall considering \
            the buttons.', 'S01E02', 1, 2, 0, 0.5, 0, 0.5, 0, 14],
...
class TestDataRecommender(unittest.TestCase):
    ...
    @patch('utils.data_manager.pd.read_csv',
           side_effect=mocked_read_csv_duplicate)
